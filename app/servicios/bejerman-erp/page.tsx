            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="rounded-2xl border border-lavanda/40 bg-card p-6 shadow-card">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-0">Queries</h3>
                </div>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div className="rounded-2xl border border-lavanda/40 bg-card p-6 shadow-card">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-0">Activo Fijo</h3>
                </div>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div className="rounded-2xl border border-lavanda/40 bg-card p-6 shadow-card">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-0">Contabilidad</h3>
                </div>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div className="rounded-2xl border border-lavanda/40 bg-card p-6 shadow-card lg:col-span-3">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-0">Producción</h3>
                </div>
                <p className="text-muted-foreground leading-relaxed">
