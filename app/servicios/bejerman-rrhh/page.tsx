        ...
        <section className="py-24 bg-background">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="rounded-2xl border border-lavanda/40 bg-card p-6 shadow-card lg:col-span-2">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 rounded-lg bg-white flex items-center justify-center">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="rounded-2xl border border-lavanda/40 bg-card p-6 shadow-card">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-foreground">e-Recibo</h3>
                </div>
                <p className="text-muted-foreground leading-relaxed">
